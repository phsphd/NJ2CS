...
{
	public static class TV2CSLogManager
	{

		private static TV2CSLogTab _logTab;
		...
		/// </summary>
		public static TV2CSLogTab LogTab
		{
			get
			{
		...
		private static void InitializeLogTab()
		{
			...
			if (!Application.Current.Dispatcher.CheckAccess())
			{
				...
				{
					throw new TimeoutException("Failed to initialize TV2CSLogTab within timeout period.");
				}
			}
			else
			{
	    ...
	    public static void Initialize()
	    {
	        ...
	        try
	        {
	            ...
	            {
	                Application.Current.Dispatcher.Invoke(() => _logTab = new TV2CSLogTab());
		...
		private static void LogInitializationError(string error, Exception ex = null)
		{
			...
			NinjaTrader.Code.Output.Process($"{ts} Failed to initialize TV2CSLogTab: {error}{details}", PrintTo.OutputTab1);
		}
	}
}